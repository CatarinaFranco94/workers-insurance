...
public class InsuranceClaimRejectFlowTests {
    ...
    public void transactionConstructedByFlowUsesTheCorrectNotary() throws Exception {
        ...
        InsuranceRejectClaimFlow.InsuranceRejectClaimInitiator flow = new InsuranceRejectClaimFlow.InsuranceRejectClaimInitiator(workerInfo.getPolicyNumber(),claimInfo.getClaimNumber(),b.getInfo().getLegalIdentities().get(0));
    ...
    public void transactionConstructedByFlowHasOneInsuranceStateOutputWithTheCorrectClaimInfo() throws Exception {
        ...
        assertEquals(ClaimStatus.Rejected, outputClaim.getClaimStatus());
        assertNull(outputClaim.getInsuranceDetail());
    }
    ...
    @Test
    public void transactionConstructedByFlowHasOneRejectClaimCommand() throws Exception {
        WorkerInfo workerInfo = new WorkerInfo("policyNr", "Alfredo", "123456", "CSW" );
        InsuranceInfo insuranceInfo = new InsuranceInfo(20000, 20, workerInfo);
        ...
        assert(command.getValue() instanceof InsuranceContract.Commands.RejectClaim);
    }
