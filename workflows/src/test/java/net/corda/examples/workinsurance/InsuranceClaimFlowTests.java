...
public class InsuranceClaimFlowTests {
    ...
    public void transactionConstructedByFlowUsesTheCorrectNotary() throws Exception {
        ...
        InsuranceClaimFlow.InsuranceClaimInitiator flow = new InsuranceClaimFlow.InsuranceClaimInitiator(claimInfo, workerInfo.getPolicyNumber());
    ...
    public void transactionConstructedByFlowHasOneInsuranceStateOutputWithTheCorrectClaimInfo() throws Exception {
        ...
        assertEquals(claimInfo.getClaimNumber(), output.getClaims().get(0).getClaimNumber());
        assertEquals(ClaimStatus.Proposal, output.getClaims().get(0).getClaimStatus());
    ...
    @Test
    public void transactionConstructedByFlowHasOneAddClaimCommand() throws Exception {
        WorkerInfo workerInfo = new WorkerInfo("policyNr", "Alfredo", "123456", "CSW" );
        InsuranceInfo insuranceInfo = new InsuranceInfo(20000, 20, workerInfo);
        ...
        assert(command.getValue() instanceof InsuranceContract.Commands.AddClaim);
    }
